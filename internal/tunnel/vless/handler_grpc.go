...
import (
	...
	xraynet "liuproxy_go/internal/xray_core/common/net"
	"liuproxy_go/internal/xray_core/common/serial"
	"liuproxy_go/internal/xray_core/transport/internet"
	"liuproxy_go/internal/xray_core/transport/internet/grpc"
...
func HandleGRPCConnection(
	...
	if err != nil {
		...
		// 远程连接失败时，不再静默关闭，而是尝试给客户端一个SOCKS5错误响应
		// 虽然此时SOCKS5握手已经“成功”，但这比让客户端超时要好
